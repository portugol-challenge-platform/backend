...
import { Classe, Continua, Enquanto, Escolha, Escreva, Expressao, Fazer, FuncaoDeclaracao as FuncaoDeclaracao, Importar, Leia, Para, ParaCada, Retorna, Se, Sustar, Tente, Var } from '../declaracoes';
